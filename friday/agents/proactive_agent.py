...
called from your app startup:
    ...
    from friday.agents.proactive_agent import register_cron
...
from friday.tools.approval_store import (
...
from friday.tools.proactive_tools import get_store
    ...
    if channel_type == "imessage":
        ...
        class _IMessageShim(BaseChannel):
            ...
            def send(
                ...
                from friday.channels.imessage_daemon import send_imessage
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from friday.tools.proactive_tools import (
            CheckPermissionTool,
