...
scope for the FRIDAY port (and was out of scope in the hybrid harness).
...
from friday.agents.hybrid._base import LocalCloudAgent
from friday.agents.hybrid._prices import supports_temperature
