...
matrix (see ``.friday/experiments/hybrid/docs/results-table.md``).
...
from friday.agents.hybrid._prices import cost as estimate_cost
from friday.agents.hybrid._prices import default_max_output_tokens
