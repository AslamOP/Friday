...
# src/friday/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m friday.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m friday.agents.hybrid.runner --cell ${name}"
