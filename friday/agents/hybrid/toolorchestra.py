...
from friday.agents.hybrid._base import (
...
from friday.agents.hybrid.mini_swe_agent import (
    _clone_repo,
    _extract_diff,
    run_swe_agent_loop,
)
...
# Map the orchestrator's `model` slot to a concrete FRIDAY worker spec.
...
def _call_tavily_search(
    ...
    Token counts are reported as zero (no LLM was billed); the FRIDAY
...
_MODAL_APP_NAME = "friday-toolorchestra-sandbox"
