...
if TYPE_CHECKING:
    from friday.core.types import ToolSpec  # noqa: F401
...
def load_mcp_tools_from_config(
    ...
    *,
    ...
    """
    # ``enabled`` and ``servers`` come from friday.core.config's
    ...
    # Imported lazily so that `friday.mcp.loader` can be imported
