...
def _build_backend(
    ...
    if backend_name == "jarvis-agent":
        from friday.evals.backends.jarvis_agent import JarvisAgentBackend
        ...
        from friday.evals.backends.jarvis_direct import JarvisDirectBackend
        ...
        from friday.evals.backends.external import HermesBackend
        ...
        from friday.evals.backends.external import OpenClawBackend
...
def _build_dataset(benchmark: str, subset: str | None = None):
    ...
    if benchmark == "supergpqa":
        ...
        from friday.evals.datasets.terminalbench_v2_1 import (
...
def _build_scorer(benchmark: str, judge_backend, judge_model: str):
    ...
    if benchmark == "supergpqa":
        ...
        from friday.evals.scorers.terminalbench_v2_1 import (
...
def _run_terminalbench_native(
    ...
    *,
    ...
    """
    from friday.engine.openai_compat_engines import normalize_openai_base_url
...
def reparse_judge(jsonl_path, out_path, in_place, summary_out):
    ...
    from friday.evals.scorers.liveresearch import rescore_from_metadata
