...
from friday.evals.cli import _build_backend, _run_terminalbench_native
...
class TestBuildBackendForwardsEndpoint:
    @patch("friday.evals.backends.jarvis_direct.JarvisDirectBackend")
    ...
    @patch("friday.evals.backends.jarvis_agent.JarvisAgentBackend")
...
class TestTerminalBenchNativeApiBase:
    @patch("friday.evals.backends.terminalbench_native.TerminalBenchNativeBackend")
...
class TestRunSingleSuiteModeGating:
    @patch("friday.evals.cli._run_terminalbench_native")
