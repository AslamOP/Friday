...
from friday.evals.backends._commit_util import friday_commit
...
class JarvisDirectBackend(InferenceBackend):
    ...
    def __init__(
        ...
        if base_url:
            ...
            from friday.evals.backends._endpoint_util import (
    ...
    def framework_commit_value(self) -> str:
        """FRIDAY repo HEAD commit (for telemetry tagging)."""
        from friday.evals.backends._commit_util import friday_commit

        return friday_commit()
    ...
    def generate_full(
        ...
        *,
        ...
        return {
            ...
            "turn_count": 1,
            "framework": "friday",
            "framework_commit": friday_commit(),
            "error": None,
        }
