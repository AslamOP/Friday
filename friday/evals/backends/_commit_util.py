"""Shared helper for resolving the friday repo's HEAD commit."""
...
def friday_commit() -> str:
    """Return the friday repo's HEAD commit (cached, lru-1).
    ...
    """
    try:
        # Walk up to repo root: backends/ -> evals/ -> friday/ -> src/ -> repo
