...
- GitHub: https://github.com/open-jarvis/FRIDAY
- Docs: https://open-jarvis.github.io/FRIDAY/
- Discord: https://discord.gg/wfXEkpPX
- Blog: https://friday.stanford.edu/
- Install: `git clone https://github.com/open-jarvis/FRIDAY.git && cd FRIDAY && uv sync`
...
2. `http_request` POST to `https://api.github.com/repos/open-jarvis/FRIDAY/issues` with title, body mentioning reporter, labels `["bug", "from-twitter"]`.
