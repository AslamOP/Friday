...
from friday.agents._stubs import AgentContext, BaseAgent
from friday.core.events import Event, EventBus, EventType
from friday.engine._base import looks_like_context_length_error
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from friday.core.types import Message as MsgType
                    from friday.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("friday.server")
                    _logger.warning(
