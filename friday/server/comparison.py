...
<title>FRIDAY — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>FRIDAY</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      FRIDAY runs models on your own hardware. Every inference call that would
  ...
  <div class="cta">
    ...
    <div class="cta-sub">Install FRIDAY and run AI locally
      with zero API costs.</div>
    <div class="code-block">
      <code>git clone https://github.com/open-jarvis/FRIDAY.git
&& cd FRIDAY && uv sync</code>
