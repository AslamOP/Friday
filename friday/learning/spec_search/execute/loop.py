...
from friday.learning.spec_search.execute.appliers.agent import (
...
from friday.learning.spec_search.execute.appliers.intelligence import (
    SetModelForQueryClassApplier,
    SetModelParamApplier,
)
from friday.learning.spec_search.execute.appliers.lora_stub import (
    LoraStubApplier,
)
from friday.learning.spec_search.execute.appliers.tools import (
    AddToolToAgentApplier,
    EditToolDescriptionApplier,
    RemoveToolFromAgentApplier,
)
from friday.learning.spec_search.execute.base import (
    ApplyContext,
    EditApplierRegistry,
)
