...
from friday.learning.spec_search.diagnose.runner import DiagnosisRunner
from friday.learning.spec_search.execute.base import ApplyContext
from friday.learning.spec_search.execute.loop import _build_registry
from friday.learning.spec_search.gate.benchmark_gate import BenchmarkGate
from friday.learning.spec_search.gate.cold_start import check_readiness
from friday.learning.spec_search.models import (
    AutonomyMode,
    BenchmarkSnapshot,
    EditOutcome,
    EditRiskTier,
...
from friday.learning.spec_search.pending_queue import PendingQueue
from friday.learning.spec_search.plan.planner import LearningPlanner
...
class SpecSearchOrchestrator:
    ...
    def from_config(
        ...
        *,
        ...
        See ``configs/friday/examples/spec-search-quickstart.toml`` for
        the TOML schema and ``examples/friday/spec_search_quickstart.py``
