...
from friday.cli._banner import print_banner
...
def _run_research(
    *,
    ...
    from friday.agents.research_loop import DEFAULT_PLANNER_MODEL, ResearchAgent
    from friday.connectors.embeddings import OllamaEmbedder
    from friday.connectors.hybrid_search import HybridSearch
...
def _run_agent(
    ...
    from friday.mcp.loader import load_mcp_tools_from_config
...
@click.option(
    ...
    default=None,
    help=(
        "Named persona dir under ~/.friday/personas/<name>/ "
...
def ask(
    ...
    if capture_screen:
        try:
            from friday.cli._screen import capture_screen_to_temp
    ...
    # Privacy guard: a screenshot/image is sensitive, and FRIDAY is
