...
from friday.core.config import HardwareInfo, detect_hardware, load_config
from friday.core.registry import MinerRegistry
from friday.mining._constants import (
...
from friday.mining._discovery import (
    check_disk_free,
...
from friday.mining._docker import PearlDockerLauncher
from friday.mining._metrics import parse_gateway_metrics
from friday.mining._models import (
    get_pearl_model_spec,
    iter_pearl_model_specs,
    pearl_variant_for_base_model,
)
from friday.mining._stubs import Sidecar
from friday.mining.vllm_pearl import ensure_registered as ensure_vllm_registered
...
def _ensure_providers_registered() -> None:
    ...
    from friday.mining.cpu_pearl import ensure_registered as ensure_cpu_registered

    ensure_cpu_registered()
    try:
        from friday.mining.apple_mps_pearl import (
...
def logs(tail_n: int, follow: bool) -> None:
    ...
    try:
        launcher._container = client.containers.get("friday-pearl-miner")
    except Exception as exc:  # noqa: BLE001
