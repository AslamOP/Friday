"""Startup banner — FRIDAY wordmark + tagline."""

from __future__ import annotations

# "FRIDAY" rendered in the figlet "standard" font. Stored as plain text
...
def print_banner(quiet: bool = False) -> None:
    """Print the FRIDAY startup banner. No-op when quiet."""
    if quiet:
        return
    try:
