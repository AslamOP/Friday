...
import friday
from friday.cli._bootstrap import bootstrap_cmd
...
from friday.cli.mine_cmd import mine
...
from friday.cli.pearl_cmd import pearl
...
from friday.cli.self_update_cmd import self_update
...
@click.group(
    help="FRIDAY — modular AI assistant backend",
...
def cli(ctx: click.Context, verbose: bool, quiet: bool) -> None:
    ...
    if ctx.invoked_subcommand is None:
        from friday.cli._first_run import check_and_route
