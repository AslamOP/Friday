...
def chat(
    ...
    from friday.cli._bg_state import get_status
    from friday.cli._chat_banner import render_startup_banner
    ...
    from friday.cli._chat_notifications import NotificationDispatcher
    ...
    memory_service = None
    try:
        from friday.memory import build_memory_service
